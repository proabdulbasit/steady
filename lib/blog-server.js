...
async function requestJson(url, { tags, revalidate = DEFAULT_REVALIDATE_SECONDS, slug, cache, timeoutMs = 8000 } = {}) {
  let response;
  try {
    const init = {
...
export async function getBlogPosts({ limit = 10, cursor, page } = {}) {
